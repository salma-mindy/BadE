...
<head>
    <?php require_once "../include/headd.php" ?>
</head>
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li class="active grey p-3">
                                                        <a href="#" class="d-flex justify-content-between">
                                                            <img src="../upload/user.png" alt="avatar" class="avatar rounded-circle d-flex align-self-center mr-2 z-depth-1">
                                        ...
                                        <div class="col-md-8">
                                            <div class="chat-message">
                                                <ul class="list-unstyled chat">
                                                    ...
                                                    <img src="../upload/user.png" alt="avatar" class="avatar rounded-circle z-depth-1">
