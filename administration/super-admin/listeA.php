...
?>
    ...
    <head>
        ...
        <title>BAD-EVENT _ Admin | Ajouter</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="card mb-4"  style="background: #FCFCFC !important">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="table-responsive">
                                                <table id="user_data" class="table table-striped table-sm table-bordered" style="color: #565050;">
                                                    <thead>
