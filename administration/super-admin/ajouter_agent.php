...
<head>
    ...
    <title>BAD-EVENT _ Admin | Ajouter un Agent</title>
...
<body id="page-top">
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="col-lg-12">
            <div class="p-1">
              <form method="post" id="inscription" class="user" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <div class="">
                ...
                <div class="form-group row <?php echo (!empty($nom_err) && !empty($prenom_err)) ? 'has-error' : ''; ?>">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="nom" name="nom" placeholder="Nom" value='<?php echo $nom ?>'>
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="prenom" name="prenom" placeholder="Prénom" value='<?php echo $prenom ?>'>
                    <small style="color: #ff1300 !important">
                        <span class="align-items-center text-center">
                            <center>
                ...
                <div class="form-group row <?php echo (!empty($genre_err) && !empty($adresse_err) && !empty($contact_err)) ? 'has-error' : ''; ?>"">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="contact" name="contact" placeholder="Numéro Téléphone" value='<?php echo $contact ?>'>
                    <small style="color: #ff1300 !important">
                        <span class="align-items-center text-center">
                            <center>
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="adresse" name="adresse" placeholder="Lieu de résidence" value='<?php echo $adresse ?>'>
                    <small style="color: #ff1300 !important">
                        <span class="align-items-center text-center">
                            <center>
                ...
                <div class="form-group row <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>"">
                  <div class="col-sm-6 mb-3 mt-2 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="email" name="email" placeholder="Adresse Email" value='<?php echo $email?>'>
                    <small style="color: #ff1300 !important">
                        <span class="align-items-center text-center">
                            <center>
                ...
                <div class="form-group row <?php echo (!empty($motDePasse_err) && !empty($confMotDePasse_err)) ? 'has-error' : ''; ?>"">
                  <div class="col-sm-6 mb-3 mt-2 mb-sm-0">
                    <input type="password" class="form-control form-control-user" id="motDePasse" name="motDePasse" placeholder="Mot de passe" value='<?php echo $motDePasse ?>'>
                    <small style="color: #ff1300 !important">
                        <span class="align-items-center text-center">
                            <center>
                  ...
                  <div class="col-sm-6 mt-2">
                    <input type="password" class="form-control form-control-user" id="confMotDePasse" name="confMotDePasse" placeholder="confirmez le mot de passe" value='<?php echo $confMotDePasse ?>'>
                    <small style="color: #ff1300 !important">
                        <span class="align-items-center text-center">
                            <center>
