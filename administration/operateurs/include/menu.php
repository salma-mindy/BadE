<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background: #000 !important;">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="./be-acteur.php">
                        <i class="fa fa-plus-square" aria-hidden="true"></i>
                        <span>Ajouter un type d'acteur</span>
                    </a>
                </li>
                <li class="nav-item dropdown dropright no-arrow">
                    <a class="nav-link" href="#" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                        <i class="fa fa-plus-square" aria-hidden="true"></i>
                        <span>Ajouter un lieu</span>
                    </a>
                    <div class="dropdown-menu">
                    <a class="dropdown-item" href="ajouter-pays.php">Ajouter un pays</a>
                    <a class="dropdown-item" href="ajouter-ville.php">Ajouter une ville</a>
                    </div>
                </li>
                <li class="nav-item">
