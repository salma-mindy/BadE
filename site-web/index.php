...
<br><br>
          ...
          <div class="col mt-0">
                <ul class="row list-inline justify-content-center" >
                    <li class="mx-3"><a href="search_result.php"><i class="fas mr-1 fa-search"></i>Tous</a></li>
                    <li class="mx-3"><a href="graphe1.php"><i class="fas mr-1 fa-chart-line"></i>Graph</a></li>
